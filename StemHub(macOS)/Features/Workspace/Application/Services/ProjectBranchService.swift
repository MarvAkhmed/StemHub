...
protocol ProjectBranchServiceProtocol {
    func loadBranchWorkspace(
        projectID: String,
        selectedBranchID: String,
        fallbackBranchID: String
    ) async throws -> BranchWorkspaceState
...
final class ProjectBranchService: ProjectBranchServiceProtocol {
    ...
    func loadBranchWorkspace(
        ...
        return BranchWorkspaceState(
            branches: branches,
            selectedBranch: resolvedBranch,
            versionHistory: history,
            headVersionID: resolvedBranch.headVersionID
        )
    }
