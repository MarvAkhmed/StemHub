...
protocol RemoteProjectVersionPersisting: Sendable {
    func saveVersion(_ version: ProjectVersion, projectID: String) async throws
}

protocol RemoteVersionRepository: Sendable {
...
protocol VersionRepository: RemoteVersionRepository {}
