...
final class WorkspaceViewModel: ObservableObject {
    ...
    init(
          currentUser: User?,
          persistenceStrategy: ProjectPersistenceStrategy,
          networkStrategy: ProjectNetworkStrategy,
          syncStrategy: ProjectSyncStrategy,
    ...
    convenience init(currentUser: User?) {
        self.init(
            currentUser: currentUser,
            persistenceStrategy: ProjectPersistenceService(),
            networkStrategy: ProjectNetworkService(),
            syncStrategy: ProjectSyncService(),
            bookmarkStrategy: BookmarkService()
        )
    }
