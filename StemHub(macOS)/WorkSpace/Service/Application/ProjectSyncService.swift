...
final class DefaultProjectSyncService: ProjectSyncService {
    ...
    init(
        syncOrchestrator: SyncOrchestrator = SyncOrchestrator(),
        branchRepository: BranchRepository = DefaultBranchRepository(),
        remoteSnapshotRepository: RemoteSnapshotRepository = DefaultRemoteSnapshotRepository(),
        stateStore: ProjectStateStore = UserDefaultsProjectStateStore(),
        diffEngine: DiffEngineStrategy = DefaultDiffEngineStrategy()
    ) {
