...
final class IOSSettingsViewModel: ObservableObject {
    ...
    @Published var preferredExportFormat: IOSProducerExportFormat

    private let sessionController: any SessionLoggingOut
    private let store: any IOSProducerSettingsStoring
    private var cancellables = Set<AnyCancellable>()

    init(
        authService: any SessionLoggingOut,
        store: any IOSProducerSettingsStoring
    ) {
